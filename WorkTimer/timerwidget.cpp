...
//Initializes program
TimerWidget::TimerWidget(QWidget *parent, QString name, QString path)
    : QWidget(parent)
    , ui(new Ui::TimerWidget)
{
    ...
    ui->Time->setText(SecondsToTimeString(InitialTime));
    ...
    timer->callOnTimeout(this,[this](){
        ...
        this->ui->Time->setText(SecondsToTimeString((int)TimerWidget::GetTime()));
    });}
...
//start/stop button
void TimerWidget::on_StartStop_clicked()
{
